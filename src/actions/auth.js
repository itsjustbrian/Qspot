...
export const signInToSpotify = () => (dispatch) => {
  window.location.href = window.location.hostname === 'localhost' ? 'http://localhost:5000/queuespot-917af/us-central1/redirect' : 'https://us-central1-queuespot-917af.cloudfunctions.net/redirect';
};
